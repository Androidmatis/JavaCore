...
class HighTemp {
    ...
    // Возвращает true, если вызывающий объект HighTemp
...
class InstanceMethWithObjectRefDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Количество суток, когда самая высока температура " +
                "была 89 градусов: " + count);
        // Создать и использовать еще один массив элементов HighTemp.
